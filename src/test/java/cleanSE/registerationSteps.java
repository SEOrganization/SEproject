...
/*
@Given("that the user with id {string} is logged into the application")
public void that_the_user_with_id_is_logged_into_the_application(String string) {
   
}

@When("the user try to unregister from Application without pay what he owed")
public void the_user_try_to_unregister_from_application_without_pay_what_he_owed() {
  
}

@Then("the user is not out of Application")
public void the_user_is_not_out_of_application() {
